...
class GeoserverUtilsTests extends GrailsUnitTestCase {
    ...
    protected void setUp() {
        ...
        coreGSUtils = new GeoserverUtils()
...
'''
    ...
    void testLookup() {
        ...
        GeoserverUtils.metaClass._describeLayer = { server, layer -> describeLayerCalledCount++ ; return validDescribeLayerResponse }
