...
class DummySetup extends GroovyTestCase {
    ...
    def setupConfig() {
        def Server s1 = new Server(
            uri: "http://something1.com", shortAcron: "sa1", id: 1, type: "WMS-1.1.1", scanFrequency: 100,
            name: "something1name", disable: false, opacity: 100, imageFormat: "image/gif", infoFormat: 'text/html',
            allowDiscoveries: true
        )
        def Server s2 = new Server(
            uri: "http://something2.com", shortAcron: "s2", id: 2, type: "WMS-1.1.1", scanFrequency: 10,
            name: "something2name", disable: false, opacity: 100, imageFormat: "image/gif", infoFormat: 'text/html',
            allowDiscoveries: true
        )

        def Server s3 = new Server(
            uri: "http://something3.com", shortAcron: "s3", id: 3, type: "WMS-1.1.1", scanFrequency: 10,
        ...
        def Layer l1 = new Layer(
            server: s1, blacklisted: false, abstractTrimmed: "", cache: false, styles: "",
            queryable: true, isBaseLayer: false, dataSource: "Unknown", activeInLastScan: false, name: "l1"
        )
        def Layer l2 = new Layer(
            server: s1, blacklisted: false, abstractTrimmed: "", cache: false, styles: "",
            queryable: true, isBaseLayer: false, dataSource: "Unknown", activeInLastScan: false, name: "l2"
        )
        def Layer l3 = new Layer(
            server: s2, blacklisted: false, abstractTrimmed: "", cache: false, styles: "",
        ...
        def MenuItem mi1 = new MenuItem(leaf: true, text: "menuitem1", menuPosition: 1, layer: l1, childItems: [])
        //linked to s1   (delete)
        def MenuItem mi2 = new MenuItem(leaf: true, text: "menuitem2", menuPosition: 2, layer: l1, childItems: [])
        //linked to s1   (delete)
        def MenuItem mi3 = new MenuItem(leaf: true, text: "menuitem3", menuPosition: 3, layer: l2, childItems: [])
        //linked to s1  (delete)
        def MenuItem mi4 = new MenuItem(leaf: false, text: "menuitem4", menuPosition: 4, layer: l3, childItems: [])
        //linked to s2
        def MenuItem mi5 = new MenuItem(leaf: false, text: "menuitem5", menuPosition: 5, server: s3, childItems: [])
        //linked to s3 (server, delete)
        ...
        Config conf = new Config(
            initialBbox: "180,10,-180,10", autoZoom: false,
