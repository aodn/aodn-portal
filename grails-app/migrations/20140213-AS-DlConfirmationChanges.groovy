...
databaseChangeLog = {
	...
	changeSet(author: "Angus (generated)", id: "1392276037358-1") {
        update(tableName: "config") {
            column(name: "download_cart_confirmation_window_content", value: """\
                ...
                <tr>
                    ...
                    <td><b>Have any questions?</b><br/>Please visit the '<a href="http://help.aodn.org.au/help/?q=node/9" target="_blank">Download a Dataset</a>' page of the <a href="http://help.aodn.org.au/help/" target="_blank">Portal Help</a> forum where you can find more information.</td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                </tr>
