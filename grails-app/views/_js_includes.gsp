...
<g:if env="development">
    ...
    <script type="text/javascript" src="${resource(dir: 'js/portal/filter/combiner', file: 'GaParametersBuilder.js')}"></script>
    ...
    <script type="text/javascript" src="${resource(dir: 'js/portal/ui/openlayers/layer', file: 'LayerSwitcher.js')}"></script>
    ...
    <script type="text/javascript" src="${resource(dir: 'js/portal/cart', file: 'AlaWmsInjector.js')}"></script>
    ...
    <script type="text/javascript" src="${resource(dir: 'js/portal/cart', file: 'InternalAsyncDownloadHandler.js')}"></script>
