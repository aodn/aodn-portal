...
<g:if env="development">
    <script src="${resource(dir: 'js', file: 'portal/PortalEvents.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/prototypes/Array.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/prototypes/OpenLayers.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/lang/en.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/common/LayerDescriptor.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/common/Controller.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/config/PortalConfigLoader.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/data/LayerStore.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/data/CatalogResult.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/field/FacetedDateRange.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/field/CheckBox.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/field/ValueCheckBox.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/field/MapLayersCheckBox.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/FilterSelector.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/NewSearchLink.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/SaveSearchLink.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/SavedSearchComboBox.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/CloneMapPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/GeoFacetMapToolbar.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/FacetMapPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/SaveSearchDialog.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/SavedSearchPanel.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/RightSearchTabPanel.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/search/FacetedSearchResultsGrid.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/DateSelectionPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/GeoSelectionPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/search/MetadataExtent.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/ui/ActiveLayersTreeNodeUI.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/utils/TimeUtil.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/utils/moment.min.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/utils/to-title-case.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/details/TimeComboBox.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/details/AnimationDateTimeSelectorPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/details/AnimationControlsPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/BaseFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/ComboFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/TimeFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/BoundingBoxFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/BooleanFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/NumberFilter.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/filter/FilterPanel.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/details/AodaacPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/details/DetailsPanelTab.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/details/InfoPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/ClickControl.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/LayerOptions.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/LayerParams.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/MapActionsControl.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/MapOptions.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/TemporalMap.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/Timer.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/control/Time.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/layer/NcWMS.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/openlayers/tile/TemporalImage.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/AnimationPanel.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/cart/DownloadCartConfirmationWindow.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/FeatureInfoPopup.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/Viewport.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/SelectionPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/search/SearchPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/search/FreeTextSearchPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/service/CatalogSearcher.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/search/SearchFiltersPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/data/TopTermStore.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/TermSelectionPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/data/GeoNetworkResultsStore.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/EmptyDropZonePlaceholder.js')}" type="text/javascript"></script>
    ...
    <script src="${resource(dir: 'js', file: 'portal/common/LayerOpacitySliderFixed.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/ui/MenuPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/cart/DownloadList.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/cart/DownloadCartStatus.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/cart/DownloadCartPanel.js')}" type="text/javascript"></script>
    <script src="${resource(dir: 'js', file: 'portal/openId/Popup.js')}" type="text/javascript"></script>
</g:if>
<g:else>
