...
<body>
<g:render template="/header/mainPortalHeader" model="['showLinks': false, 'configInstance': configInstance]"></g:render>
...
<div id="landing">
    ...
    <div class="footer">
        <div class="landingLeft">
            ...
            <br/>
            <a href="http://twitter.com/AusOceanDataNet" target="_blank">
                <img class="logoSpacer" src="images/Twitter_logo_black.png" title="Follow us on twitter" alt="Follow us on twitter"/></a>
            <a href="http://www.facebook.com/AusOceanDataNet" target="_blank">
                <img class="logoSpacer" src="images/FB-logo-gray.png" title="Find us on Facebook" alt="Find us on Facebook"/></a>
        ...
        <div class="landingRight">
            ...
            </a> <a target="_blank" href="http://creativecommons.org/licenses/by/2.5/au/" title="Creative Commons License" class="external"><img width="65" src="images/by.png">
            </a></p>
