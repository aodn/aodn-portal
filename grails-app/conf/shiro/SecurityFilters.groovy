...
class SecurityFilters {
    ...
    def filters = {
        ...
        homeAccess(controller: "home", action: "index|config|footerContent|css") {
            before = {
                request.accessAllowed = true
            }
        }
        ...
        layerAccess(controller: "layer", action: "listBaseLayersAsJson|showLayerByItsId|findLayerAsJson|getFormattedMetadata|saveOrUpdate|server|configuredBaselayers|getFiltersAsJSON|getStylesAsJSON|getFilterValuesAsJSON") {
            before = {
                request.accessAllowed = true
            }
        }
