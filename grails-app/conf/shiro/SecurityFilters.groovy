...
import au.org.emii.portal.WmsScannerController
    ...
    def filters = {
        ...
        editFiltersAccess(controller: "layer", action: "editFilters") {
            before = {
                ...
                request.accessAllowed = _hasLayerFilterPermission(layer)
            }
        }
        ...
        filterAccess(controller: "filter", action: "edit|update|delete|") {
            before = {
                ...
                request.accessAllowed = _hasLayerFilterPermission(filter.layer)
            }
        }
        ...
        wmsScannerAccess(controller: "wmsScanner", action: "callUpdate|callDelete") {
            before = {
                ...
                request.accessAllowed = _isServerOwner(server)
            }
        }

        wmsScannerRegisterAccess(controller: "wmsScanner", action: "callRegister") {
            before = {
                request.accessAllowed = _isServerOwner(Server.get(params.serverId))
            }
        }
