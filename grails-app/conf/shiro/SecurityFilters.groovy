...
class SecurityFilters {
    ...
    def filters = {
        ...
        layerAccess(controller: "layer", action: "listBaseLayersAsJson|showLayerByItsId|findLayerAsJson|getMetadataAbstract|saveOrUpdate|server|configuredBaselayers|getFiltersAsJSON|getStylesAsJSON|getFilterValuesAsJSON") {
            before = {
                request.accessAllowed = true
            }
        }
