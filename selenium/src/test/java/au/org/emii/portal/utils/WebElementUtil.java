...
public class WebElementUtil {
    ...
    public static void clickElementByXpath(String xpath, WebDriver driver) {
        try {
            WebElement newPersonLink = driver.findElement(By.xpath(xpath));
            if(newPersonLink!=null) {
                Actions actions = new Actions(driver);
                actions.moveToElement(newPersonLink).click().perform();
            }
    ...
    public static void clickLinkContainingText(String linkText, WebDriver driver) {
        try {
            WebElement newPersonLink = driver.findElement(By.xpath("//a[contains(.,'" + linkText + "')]"));
            Actions actions = new Actions(driver);
            actions.moveToElement(newPersonLink).click().perform();
        } catch (NoSuchElementException | AssertionError e) {
            log.error("Link text "+linkText+"could not be found", e);
    ...
    public static void enterInputStringById(String inputString, String inputId, WebDriver driver) {
        try {
            ...
            element.clear();
            Actions actions = new Actions(driver);
            actions.moveToElement(element).sendKeys(new String[]{inputString}).perform();
        } catch (NoSuchElementException | AssertionError e) {
