...
describe("Portal.data.LayerStore", function() {
    ...
    beforeEach(function() {
        layerStore = Portal.data.LayerStore.mainInstance();
        expect(layerStore.getCount()).toBe(0);
    });

    afterEach(function() {
        Portal.data.LayerStore.MAIN_INSTANCE = undefined;
    });
    ...
    describe('layer store as singleton', function() {
        ...
        it('accessor function', function() {
            expect(Portal.data.LayerStore.mainInstance()).toBeTruthy();
        });

        it('singleton', function() {
            var firstCall = Portal.data.LayerStore.mainInstance();
            var secondCall = Portal.data.LayerStore.mainInstance();
