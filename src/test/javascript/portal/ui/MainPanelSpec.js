...
describe("Portal.ui.MainPanel", function() {
    ...
    afterEach(function() {
        Ext4.MsgBus.unsubscribe(PORTAL_EVENTS.VIEW_DATA_COLLECTION, mainPanel._onViewGeoNetworkRecord, mainPanel);
    });
    ...
    describe('card layout', function() {
        ...
        it('should set visualise to active item when geonetwork record is viewed', function() {
            ...
            Ext4.MsgBus.publish(PORTAL_EVENTS.VIEW_DATA_COLLECTION);
