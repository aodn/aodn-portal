describe("Portal.search.ResultsGrid", function() {
   ...
   describe("hasProtocol", function() {
      ...
      it('Should identify links containing protocol', function() {
    	  expect(resultGrid.hasProtocol(testData, ["OGC:WMS-1.1.1-http-get-map"])).toEqual(true);
      });
      
      it('Should identify links containing one of the protocols', function() {
    	  expect(resultGrid.hasProtocol(testData, ["OGC:WMS-1.3.0-http-get-map", "OGC:WMS-1.1.1-http-get-map"])).toEqual(true);
      });
      
      it('Should identify links not containing protocol', function() {
    	  expect(resultGrid.hasProtocol(testData, ["OGC:WMS-1.2.1-http-get-map"])).toEqual(false);
      });
      
      it('Should identify links not containing one of the protocols', function() {
    	  expect(resultGrid.hasProtocol(testData, ["OGC:WMS-1.3.0-http-get-map", "OGC:WMS-1.2.1-http-get-map"])).toEqual(false);
      });
