...
describe("Portal.seaarch.SearchResultBounds", function() {
    ...
    describe('search result extent calculations', function() {
        it("gets the longest bounding box direction longitude", function() {
            var bounds = new Portal.search.SearchResultsBounds({ bbox: bbox });
            expect(bounds._longestBoundingEdgeDirection()).toEqual("longitude");
        });

        it("gets the longest bounding box direction latitude", function() {
            bbox.west = 0;
            bbox.east = 10;
            var bounds = new Portal.search.SearchResultsBounds({ bbox: bbox });
            expect(bounds._longestBoundingEdgeDirection()).toEqual("latitude");
        });

        it("gets the longest bounding box length", function() {
            var bounds = new Portal.search.SearchResultsBounds({ bbox: bbox });
            expect(bounds._longestBoundingEdgeLength()).toEqual(270);
        });
        ...
        it("gets the longest bounding box length", function() {
            ...
            bbox.east = 10;
            var bounds = new Portal.search.SearchResultsBounds({ bbox: bbox });
            expect(bounds._longestBoundingEdgeLength()).toEqual(110);
        });
    });
