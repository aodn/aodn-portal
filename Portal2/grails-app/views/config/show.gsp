	...
	<body>
		...
		<div id="show-config" class="content scaffold-show" role="main">
			...
			<ol class="property-list config">
				...
				<g:if test="${configInstance?.binding}">
				<li class="fieldcontain">
					<span id="binding-label" class="property-label"><g:message code="config.binding.label" default="Binding" /></span>
					
						<span class="property-value" aria-labelledby="binding-label"><g:fieldValue bean="${configInstance}" field="binding"/></span>
