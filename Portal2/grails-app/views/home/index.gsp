...
<script src="${resource(dir:'js',file:'portal/lang/en.js')}" defer="defer"  type="text/javascript"></script>
...
<script src="${resource(dir:'js',file:'portal/search/LayerSelectionWindow.js')}" defer="defer"  type="text/javascript"></script>
