...
Portal.cart.DownloadPanelItemTemplate = Ext.extend(Ext.XTemplate, {
    ...
    constructor: function (downloadPanel) {
        ...
        var templateLines = [
            ...
            '    <div class="floatLeft dataFilterEntry" style="width:700px">',
    ...
    _createDownloadButton: function (id, collection) {
        if (collection.gogoduckParams || collection.wmsLayer.wfsLayer || collection.wmsLayer.urlDownloadFieldName) {
            new Ext.Button({
