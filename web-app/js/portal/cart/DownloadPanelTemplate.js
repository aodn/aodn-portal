...
Portal.cart.DownloadPanelTemplate = Ext.extend(Ext.XTemplate, {
    ...
    _dataRowTemplate: function(values) {
        ...
        if (values.aodaac) {
            ...
            html += new Portal.cart.NoDataRowTemplate(this).applyWithControls(values);
        }
    ...
    downloadWithConfirmation: function(downloadUrl, downloadFilename, additionalQueryArgs) {
        this.downloadPanel.confirmationWindow.showIfNeeded(downloadUrl, downloadFilename, additionalQueryArgs);
    }
});
