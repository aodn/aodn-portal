...
Portal.cart.NcWmsInjector = Ext.extend(Portal.cart.BaseInjector, {
    ...
    _getDataFilterEntry: function(collection) {
        ...
        else if (!time || (collection.layerAdapter.layerSelectionModel && Object.keys(collection.layerAdapter.layerSelectionModel.selectedLayer.temporalExtent.extent) == 0)) {
